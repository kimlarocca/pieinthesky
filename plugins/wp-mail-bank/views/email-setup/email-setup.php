												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="ux_txt_cc" disabled="disabled" id="ux_txt_cc" value="<?php echo isset($email_configuration_array["cc"]) ? $email_configuration_array["cc"] : "" ?>" placeholder="<?php echo $mb_email_configuration_cc_email_placeholder; ?>">
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="ux_txt_bcc" disabled="disabled" id="ux_txt_bcc" value="<?php echo isset($email_configuration_array["bcc"]) ? $email_configuration_array["bcc"] : "" ?>" placeholder="<?php echo $mb_email_configuration_bcc_email_placeholder; ?>">
														</div>
													</div>
												</div>
												<div class="form-group">
														...
														<div class="col-md-6">
															<div class="form-group">
																...
																<select name="ux_ddl_mb_authentication" id="ux_ddl_mb_authentication" class="form-control" onchange="select_credentials_mail_bank()">
																	...
																	<option value="plain"><?php echo $mb_email_configuration_use_username_and_password;?></option>
																</select>
															</div>
														</div>
													</div>
											...
											<form id="ux_frm_test_email_configuration">
												<div id="ux_div_test_mail">
													...
													<div class="form-group">
														...
														<?php
														$email_configuration = "This is a demo Test Email for Email Configuration - Mail Bank";
